...
![The KiCAD menu, highlighting the DRC option underneath the "tools" submenu, under the title bar.](/assets/docimg\kicad_xOUEhjUNW0.png)
...
![A failing DRC pass](/assets/docimg/kicad_OvKKx1TbyM.png)
